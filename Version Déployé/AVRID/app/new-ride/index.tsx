...
const PosterScreen = () => {
  ...
  const checkActiveTrip = async () => {
    try {
      ...
      const response = await fetch("https://testat-hsrz.onrender.com/api/posts/creat_post/", {
        headers: {
      ...
      Alert.alert(
        ...
        [
          ...
          },
          {
            ...
            style: "destructive",
            onPress: async () => {
              const response = await fetch(`https://testat-hsrz.onrender.com/api/posts/delete/${encodeURIComponent(activePostTitle)}/`, {
                method: "DELETE",
                headers: {
                  "Authorization": `Bearer ${token}`
                }
