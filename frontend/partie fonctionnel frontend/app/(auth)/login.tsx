...
const SignInScreen = () => {
  ...
  username: email, // ou juste username si c’est un champ différent
  password
});
  ...
  const handleSocialLoginSuccess = async (provider: string, token: string) => {
    try {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity
            ...
            disabled={loading}
          >
            {loading ? <ActivityIndicator color="white" /> : <Text style={styles.primaryButtonText}>CONTINUE</Text>}
          </TouchableOpacity>
        </View>
